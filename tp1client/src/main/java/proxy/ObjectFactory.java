...
public class ObjectFactory {
    ...
    private final static QName _ListesCompte_QNAME = new QName("http://ws/", "listesCompte");
    private final static QName _ListesCompteResponse_QNAME = new QName("http://ws/", "listesCompteResponse");
